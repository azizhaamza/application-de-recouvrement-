                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="name" id="name" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('name', $district->nom_district) }}" />
                            @error('name')
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="adresse" id="adresse" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('adresse', $district->adresse_district) }}" />
                            @error('adresse')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="number" max="7" name="id_region" id="id_region" class="form-input rounded-md shadow-sm mt-1 block w-full"
                            value="{{ old('adresse', $district->id_region) }}" />
                            @error('id_region')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
